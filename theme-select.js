...
const themes = {
    "90s": {
      ...
      projectList: "background: linear-gradient(to bottom, #ffffff, #d3d3d3); box-shadow: 4px 4px black inset, 4px 4px black;",
      config: "border: 2px solid #000; padding: 10px; background: linear-gradient(to bottom, #ffffff, #d3d3d3); box-shadow: 4px 4px black;",
      button: "background-color: #ffa500; color: black; border: 2px solid black; padding: 5px 15px; cursor: pointer;",
    ...
    "2000s": {
      ...
      config: "border: 1px solid #ccc; padding: 10px; background: #ffffff; box-shadow: 2px 2px 5px #ccc;",
      button: "background-color: #e0e0e0; color: black; border: 1px solid #aaa; padding: 5px 15px; cursor: pointer;",
    ...
    "2010s": {
      ...
      config: "border: 1px solid #ddd; padding: 10px; background: #fafafa; box-shadow: 1px 1px 3px #ddd;",
      button: "background-color: #f5f5f5; color: black; border: 1px solid #bbb; padding: 6px 16px; cursor: pointer;",
    ...
    "2020s": {
      ...
      projectList: "background: #2a2a2a; box-shadow: 3px 3px 5px #000; color: #f5f5f5;",
      config: "border: 1px solid #333; padding: 12px; background: #2a2a2a; box-shadow: 3px 3px 5px #000;",
      button: "background-color: #333333; color: #f5f5f5; border: 1px solid #555; padding: 7px 18px; cursor: pointer;",
      buttonHover: "background-color: #444444; color: #ffffff;",
      input: "border: 1px solid #555; padding: 6px; background-color: #2a2a2a; color: #f5f5f5;",
    ...
    future: {
      ...
      projectList: "background: #111; box-shadow: 0 0 15px #0ff inset, 5px 5px 15px #0ff;",
      config: "border: 2px solid #0ff; padding: 12px; background: #111; box-shadow: 0 0 15px #0ff inset, 5px 5px 15px #0ff;",
      button: "background-color: #0ff; color: #000; border: 2px solid #0ff; padding: 8px 20px; cursor: pointer;",
      buttonHover: "background-color: #00b7ff; color: #000;",
      input: "border: 2px solid #0ff; padding: 6px; background-color: #111; color: #0ff;",
      links: "list-style-type: none; padding-left: 20px; text-align: left;",
